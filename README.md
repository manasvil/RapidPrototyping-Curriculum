...
### Milestone: Publish content on Github or another open platform
...
### Milestone: Generalize the curriculum so it is not just Georgia Tech specific
E.g. in places it references resources on the GT campus, we could either strip those details or de-emphasize them

### Milestone: Proofreading and Attribution
...
### Milestone: Improved Information Architecture based on feedback from makers, curriculum designers
Need design research to obtain feedback on the existing IA of the course material.

### Milestone: Create activity sheets/handouts for existing assignments
...
### Milestone: Testing in the wild!
Have someone actually use the curriculum or portions of the curriculum in a class or workshop form


### Milestone: Present at[ Global Sprint (May 10-11)](https://foundation.mozilla.org/opportunity/global-sprint/)
